...
<style>
  ...
  .konu {
    background-image: url('images/waterimg.png');
...
<body style="background-image:url('images/water.gif'); 
             background-size: cover; 
             background-attachment: fixed;
             background-position: center; ">
        <div class=" header" style="background-size: 200px 100px;">
    ...
    <form action="anketsonuc.php" method="post">
        ...
        <p>2-Yaş aralığınız. </p>
          <label for="yas_14_17"> <input type="radio" name="yas" id="yas_14_17" value="14-17">14-17</label><br>
          <label for="yas_18_23"> <input type="radio" name="yas" id="yas_18_23" value="18-23">18-23</label><br>
          <label for="yas_24_30"> <input type="radio" name="yas" id="yas_24_30" value="24-30">24-30</label><br>
          <label for="yas_31_plus"> <input type="radio" name="yas" id="yas_31_plus" value="31+"> 31+</label>

        <p>3-Cinsiyetiniz.</p>
          <label for="cinsiyet_bay"> <input type="radio" name="cinsiyet" id="cinsiyet_bay" value="Bay">Bay</label><br>
          <label for="cinsiyet_bayan"> <input type="radio" name="cinsiyet" id="cinsiyet_bayan" value="Bayan"> Bayan</label><br>
          <label for="cinsiyet_belirtmek_istemiyorum"> <input type="radio" name="cinsiyet" id="cinsiyet_belirtmek_istemiyorum" value="Belirtmek İstemiyorum">Belirtmek İstemiyorum</label>
        ...
        <p>16-Günde kaç bardak kahve içersiniz? (Bir fincan kahve için, tohumun toprağa ekimesinden önümüze gelmesine kadar geçen toplam sürede 140 litre su harcanıyor.)</p>
